# Web Experience Brief - Aurora Hotel
...
- Semantic color tokens are required.
- Reduced-motion behavior is required.
- WCAG 2.2 AA is the accessibility target.

## Unresolved implementation choices
- Unresolved named tokens, type roles, hierarchy, and component rules.
- Unresolved owner approval and design lock hash.
